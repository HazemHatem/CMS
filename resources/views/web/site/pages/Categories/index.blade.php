...
<section class="LandingPage col-12">
  ...
  <style>
    ...
    .landing{
   background-image: linear-gradient(135deg, rgba(30, 33, 33, 0.82) 1%, rgba(32, 32, 32, 0) 0), url("{{asset('site/Style/image/categories/landing.jpg')}}");
   height: 45vh;
...
<section class="landing col-12">
  ...
  <div class="col-6">
    <span class="title"><h1>Categories</h1></span>
